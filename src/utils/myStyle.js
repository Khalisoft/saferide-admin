const myStyle = {
	...
	badge: {
		...
		primary: "text-primary bg-gray-200 dark:text-white dark:bg-primary",
	},
	// Backdrop
	backdrop: {
	...
	// Textarea
	textarea: {
		base: "block w-full border py-2 pl-2 text-sm dark:text-gray-300 rounded-md focus:outline-none",
		active:
			"focus:border-primary border-gray-300 dark:border-gray-600 dark:focus:border-gray-600 dark:bg-gray-700 dark:focus:ring-gray-300 focus:ring focus:ring-primary",
	...
	// Select
	select: {
		base: "block w-full border py-2 pl-2 text-sm dark:text-gray-300 focus:outline-none rounded-md",
		active:
			"focus:border-primary border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring focus:ring-primary dark:focus:ring-gray-300 dark:focus:border-gray-600",
		select: "leading-5",
		disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
		valid:
			"border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200",
	...
	// Input
	input: {
		base: "block w-full border py-2 pl-2 text-sm focus:outline-none dark:text-gray-300 leading-5 rounded-md",
		active:
			"focus:border-primary border-gray-300 dark:border-gray-600 focus:ring focus:ring-primary dark:focus:border-gray-600 dark:focus:ring-gray-300 dark:bg-gray-700",
		disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
		valid:
			"border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200",
		invalid:
			"border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200",
		radio:
			"text-primary border form-radio focus:border-primary focus:outline-none focus:ring focus:ring-primary focus:ring-offset-0 dark:focus:ring-gray-300",
		checkbox:
			"text-primary border form-checkbox focus:border-primary focus:outline-none focus:ring focus:ring-primary focus:ring-offset-0 rounded dark:focus:ring-gray-300",
	},
	// HelperText
	helperText: {
		base: "text-xs",
	...
	// Card
	card: {
		base: "min-w-0 shadow-lg m-1 rounded-lg overflow-hidden",
	...
	button: {
		...
		primary: {
			...
			active:
				"active:bg-primary hover:bg-secondary hover:text-primary hover:border-primary focus:ring focus:ring-primary",
			disabled: "opacity-50 cursor-not-allowed",
		},
		outline: {
